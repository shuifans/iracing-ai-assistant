      ...
      {activeTab === 'file' ? (
        <div className="space-y-4">
          ...
          <button
            ...
            className="inline-flex min-h-[44px] min-w-[44px] items-center justify-center rounded-lg bg-brand-600 px-6 py-2 text-sm font-medium text-white transition-colors hover:bg-brand-700 focus:outline-none focus:ring-2 focus:ring-brand-500/40 disabled:cursor-not-allowed disabled:opacity-50"
          >
            {submitting ? '上传中…' : '上传文件'}
          </button>
        </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="min-h-[44px] w-full rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm text-gray-700 placeholder:text-gray-400 focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500"
            />
          </div>
          <div>

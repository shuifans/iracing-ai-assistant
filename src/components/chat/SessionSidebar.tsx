    ...
    <>
      ...
      >
        ...
        <div className="border-t border-gray-800 px-3 py-2">
          <button
            type="button"
            onClick={() => { router.push('/chat/diagnostic'); onClose(); }}
            className={`flex min-h-[44px] w-full items-center gap-2 rounded-lg px-3 py-1.5 text-[13px] leading-5 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500/40 ${
